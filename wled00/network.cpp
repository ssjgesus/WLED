...
// IP101 wiring also used by troyhacks/WLED P4_experimental (wled.cpp).
// Keep the existing IP101 board ID; other classic ESP32 profiles are invalid on P4.
const managed_pin_type esp32_nonconfigurable_ethernet_pins[WLED_ETH_RSVD_PINS_COUNT] = {
  { ETH_RMII_TX_EN, true }, { ETH_RMII_TX0, true }, { ETH_RMII_TX1, true },
  { ETH_RMII_RX0, false }, { ETH_RMII_RX1_EN, false }, { ETH_RMII_CRS_DV, false }
};
const ethernet_settings ethernetBoards[WLED_NUM_ETH_TYPES] = {
  {}, {}, {}, {}, {}, {}, {},
  { 1, 51, 31, 52, ETH_PHY_IP101, EMAC_CLK_EXT_IN }
};
// AI: end
...
bool initEthernet()
{
  ...
  if (ethernetType != WLED_ETH_ESP32ETHKITVE) return false;
#endif
  // AI: end
  ...
  // AI: below section was generated by an AI
#if CONFIG_IDF_TARGET_ESP32P4
  pinsToAllocate[9] = { ETH_RMII_CLK, false };
#else
  // AI: end
